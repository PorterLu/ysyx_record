...
void VmyCPU___024root__trace_chg_sub_0(VmyCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgCData(oldp+74,((0xfU & (IData)(vlSelf->myCPU__DOT__control__DOT__ctrlSignals_5))),4);
        ...
        bufp->chgCData(oldp+129,(vlSelf->myCPU__DOT__control__DOT__ctrlSignals_5),5);
        bufp->chgBit(oldp+130,((vlSelf->myCPU__DOT__immGen_io_inst 
                                >> 0x1fU)));
        bufp->chgSData(oldp+131,((vlSelf->myCPU__DOT__immGen_io_inst 
                                  >> 0x14U)),12);
        bufp->chgQData(oldp+132,(vlSelf->myCPU__DOT__immGen__DOT__Iimm),44);
        bufp->chgSData(oldp+134,(((0xfe0U & (vlSelf->myCPU__DOT__immGen_io_inst 
                                             >> 0x14U)) 
                                   ...
                                   << 0xcU) | (QData)((IData)(
                                                              ((0xfe0U 
                                                               ...
                                                               | (0x1fU 
                                                                  & (vlSelf->myCPU__DOT__immGen_io_inst 
                                                                     >> 7U))))))),44);
        bufp->chgSData(oldp+137,(((0x1000U & (vlSelf->myCPU__DOT__immGen_io_inst 
                                              >> 0x13U)) 
                                                               ...
                                                               | ((0x800U 
                                                                  ...
                                                                  | ((0x7e0U 
                                                                     ...
                                                                     | (0x1eU 
                                                                        & (vlSelf->myCPU__DOT__immGen_io_inst 
                                                                           >> 7U))))))))),45);
        bufp->chgIData(oldp+140,((0xfffff000U & vlSelf->myCPU__DOT__immGen_io_inst)),32);
        ...
        bufp->chgIData(oldp+143,(((0x100000U & (vlSelf->myCPU__DOT__immGen_io_inst 
                                                >> 0xbU)) 
                                     ...
                                     | ((0x800U & (vlSelf->myCPU__DOT__immGen_io_inst 
                                        ...
                                        | ((0x7e0U 
                                           ...
                                           | (0x1eU 
                                              & (vlSelf->myCPU__DOT__immGen_io_inst 
                                                 >> 0x14U))))))),21);
        bufp->chgQData(oldp+144,(vlSelf->myCPU__DOT__immGen__DOT__Jimm),53);
        bufp->chgCData(oldp+146,((0x1fU & (vlSelf->myCPU__DOT__immGen_io_inst 
                                           >> 0xfU))),6);
        bufp->chgQData(oldp+147,((QData)((IData)((0x1fU 
                                                  & (vlSelf->myCPU__DOT__immGen_io_inst 
                                                     >> 0xfU))))),38);
    }
    bufp->chgBit(oldp+149,(vlSelf->clock));
    bufp->chgBit(oldp+150,(vlSelf->reset));
    bufp->chgQData(oldp+151,(vlSelf->io_pc_debug),64);
}
