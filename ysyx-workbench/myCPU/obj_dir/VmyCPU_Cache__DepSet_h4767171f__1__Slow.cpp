...
VL_ATTR_COLD void VmyCPU_Cache___settle__TOP__myCPU__DOT__dcache__0(VmyCPU_Cache* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+        VmyCPU_Cache___settle__TOP__myCPU__DOT__dcache__0\n"); );
    // Init
    ...
    if ((0U == (IData)(vlSelf->__PVT__cache_state))) {
        ...
        vlSelf->io_mem_io_w_bits_last = ((4U == (IData)(vlSelf->__PVT__cache_state)) 
                                         | (IData)(vlSelf->__PVT__last));
        vlSelf->__PVT__max = ((4U == (IData)(vlSelf->__PVT__cache_state))
                               ? 0U : ((5U == (IData)(vlSelf->__PVT__cache_state))
                                        ? 0U : ((7U 
                                                 == (IData)(vlSelf->__PVT__cache_state))
                                                 ? 
                                                (((((IData)(vlSelf->__PVT__is_match_0) 
    ...
    if ((3U == (IData)(vlSelf->__PVT__cache_state))) {
        ...
        vlSelf->__PVT___GEN_1671 = vlSelf->__PVT___GEN_0;
        ...
        vlSelf->__PVT___GEN_1664 = vlSelf->__PVT__refill_addr;
        vlSelf->__PVT___GEN_1671 = ((0xaU == (IData)(vlSelf->__PVT__cache_state))
                                     ? (IData)(vlSelf->__PVT___GEN_0)
                                     : ((9U == (IData)(vlSelf->__PVT__cache_state))
                                         ? ((IData)(vlSymsp->TOP.io_master_rlast)
                                             ? 0U : (IData)(vlSelf->__PVT___GEN_0))
                                         : ((0xbU == (IData)(vlSelf->__PVT__cache_state))
                                             ? (IData)(vlSelf->__PVT___GEN_0)
                                             : ((8U 
                                                 == (IData)(vlSelf->__PVT__cache_state))
                                                 ? 
