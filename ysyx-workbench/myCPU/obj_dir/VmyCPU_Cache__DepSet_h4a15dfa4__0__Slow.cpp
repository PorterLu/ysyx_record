...
VL_ATTR_COLD void VmyCPU_Cache___settle__TOP__myCPU__DOT__icache__1(VmyCPU_Cache* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VmyCPU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        VmyCPU_Cache___settle__TOP__myCPU__DOT__icache__1\n"); );
    // Init
