...
VL_ATTR_COLD void VmyCPU___024root___ctor_var_reset(VmyCPU___024root* vlSelf) {
    ...
    VL_RAND_RESET_W(127, vlSelf->myCPU__DOT__alu__DOT___out_T_74);
    VL_RAND_RESET_W(128, vlSelf->myCPU__DOT__alu__DOT___out_T_84);
    VL_RAND_RESET_W(128, vlSelf->myCPU__DOT__alu__DOT___out_T_88);
    ...
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_210 = VL_RAND_RESET_I(1);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_229 = VL_RAND_RESET_I(1);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_264 = VL_RAND_RESET_I(1);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_281 = VL_RAND_RESET_I(1);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_312 = VL_RAND_RESET_I(2);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_327 = VL_RAND_RESET_I(2);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_342 = VL_RAND_RESET_I(2);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_370 = VL_RAND_RESET_I(3);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_385 = VL_RAND_RESET_I(3);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_400 = VL_RAND_RESET_I(3);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_429 = VL_RAND_RESET_I(5);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_444 = VL_RAND_RESET_I(5);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_459 = VL_RAND_RESET_I(5);
    vlSelf->myCPU__DOT__control__DOT__ctrlSignals_5 = VL_RAND_RESET_I(5);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_586 = VL_RAND_RESET_I(3);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_649 = VL_RAND_RESET_I(3);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_665 = VL_RAND_RESET_I(2);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_680 = VL_RAND_RESET_I(2);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_695 = VL_RAND_RESET_I(2);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_740 = VL_RAND_RESET_I(1);
    vlSelf->myCPU__DOT__control__DOT___ctrlSignals_T_760 = VL_RAND_RESET_I(1);
