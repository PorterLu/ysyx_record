...
VL_MODULE(VmyCPU___024root) {
  public:
    ...
    struct {
        ...
        CData/*3:0*/ myCPU__DOT__control_io_alu_op;
        ...
        CData/*0:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_198;
        CData/*0:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_215;
        CData/*0:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_244;
        CData/*0:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_261;
        CData/*1:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_292;
        CData/*1:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_307;
        CData/*1:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_322;
        CData/*2:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_346;
        CData/*2:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_361;
        CData/*2:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_376;
        CData/*3:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_401;
        CData/*3:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_416;
        CData/*3:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_431;
        CData/*2:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_546;
        CData/*2:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_605;
        CData/*1:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_621;
        CData/*1:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_636;
        CData/*1:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_651;
        CData/*0:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_692;
        CData/*0:0*/ myCPU__DOT__control__DOT___ctrlSignals_T_709;
        ...
        VlWide<4>/*127:0*/ myCPU__DOT__alu__DOT___out_T_46;
        VlWide<4>/*127:0*/ myCPU__DOT__alu__DOT___out_T_50;
